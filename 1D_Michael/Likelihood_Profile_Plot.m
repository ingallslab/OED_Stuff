...
u = u(1:round(inc):end);    
[u_opt, w_opt]=D_opt_c([0.5,3,9,3,-18.1,111.7],Omega,u,FIM_comp([0.5,3,9,3,-18.1,111.7],Omega,u,[0.1,0.2]),[0.1,0.2]);
...
subplot(2,2,1);
hold on
plotlik(solution,mini,xvals,syms,1);
plotQuad(solution,mini,xvals,syms,1,G,H);
hold off
subplot(2,2,2);
hold on
plotlik(solution,mini,xvals,syms,2);
plotQuad(solution,mini,xvals,syms,2,G,H);
hold off
subplot(2,2,3);
hold on
plotlik(solution,mini,xvals,syms,3);
plotQuad(solution,mini,xvals,syms,3,G,H);
hold off
subplot(2,2,4);
hold on
plotlik(solution,mini,xvals,syms,4);
plotQuad(solution,mini,xvals,syms,4,G,H);
hold off


function plotlik(solution,mini,xvals,syms,K)
